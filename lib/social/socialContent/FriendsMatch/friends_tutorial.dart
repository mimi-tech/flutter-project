...
class SocialFriendsMatchTutorial extends StatefulWidget {
  @override
  _SocialFriendsMatchTutorialState createState() => _SocialFriendsMatchTutorialState();
}

class _SocialFriendsMatchTutorialState extends State<SocialFriendsMatchTutorial> {
  bool progress = false;
  ...
  Future<void> loadMore() async {
    ...
    final QuerySnapshot result = await FirebaseFirestore.instance.collectionGroup('userSessionUploads')
        .where('aoi',arrayContainsAny: GlobalVariables.loggedInUserObject.aoi)
        .orderBy('as',descending: true).
