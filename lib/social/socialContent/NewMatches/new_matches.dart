...
class SocialNewMatches extends StatefulWidget {
  @override
  _SocialNewMatchesState createState() => _SocialNewMatchesState();
}

class _SocialNewMatchesState extends State<SocialNewMatches> {
  bool progress = false;
