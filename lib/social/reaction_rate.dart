...
class RateReactions extends StatefulWidget {

  RateReactions({required this.doc});
  final DocumentSnapshot doc;
  @override
  _RateReactionsState createState() => _RateReactionsState();
}

class _RateReactionsState extends State<RateReactions> {
 ...
 late ChewieController _chewieController;
  ...
  void initState() {
    ...
    FirebaseFirestore.instance.collection('ratedVideos').where('id',isEqualTo: widget.doc['id']).snapshots()
                                  ...
                                  return Column(
                                    children: [
                                      ReactionText(
                                        ...
                                        text3: data['ln'],
                                        text4: 'Rated by',
                                        text5: '${_products.length.toString()} rate(s)',
                                      ),
                                    ],
                                  );
                                }).toList()
  ...
  void requestNextPage() async {
    ...
    if (!_isRequesting && !_isFinish) {
      ...
      if (_products.isEmpty) {
        ...
        querySnapshot = await FirebaseFirestore.instance.collection('ratedVideos').where('id',isEqualTo: widget.doc['id'])
