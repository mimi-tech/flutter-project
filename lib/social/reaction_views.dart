...
class ViewsReactions extends StatefulWidget {

  ViewsReactions({required this.doc});
  final DocumentSnapshot doc;
  @override
  _ViewsReactionsState createState() => _ViewsReactionsState();
}

class _ViewsReactionsState extends State<ViewsReactions> {
  ...
  void initState() {
    ...
    FirebaseFirestore.instance.collection('viewedVideos').where('id',isEqualTo: widget.doc['id']).snapshots()
                                  ...
                                  return Column(
                                    children: [
                                      ReactionText(
                                        ...
                                        text3: data['ln'],
                                        text4: 'Viewed by',
                                        text5: '${_products.length.toString()} views',
                                      ),
                                    ],
                                  );
                                }).toList()
  ...
  void requestNextPage() async {
    ...
    if (!_isRequesting && !_isFinish) {
      ...
      if (_products.isEmpty) {
        ...
        querySnapshot = await FirebaseFirestore.instance.collection('viewedVideos').where('id',isEqualTo: widget.doc['id'])
