...
class ShareReactions extends StatefulWidget {

  ShareReactions({required this.doc});
  final DocumentSnapshot doc;
  @override
  _ShareReactionsState createState() => _ShareReactionsState();
}

class _ShareReactionsState extends State<ShareReactions> {
 ...
 late ChewieController _chewieController;
  ...
  void initState() {
    ...
    FirebaseFirestore.instance.collection('sharedVideos').where('id',isEqualTo: widget.doc['id']).snapshots()
                                  ...
                                  return Column(
                                    children: [
                                      ReactionText(
                                        ...
                                        text3: data['ln'],
                                        text4: 'Shared by',
                                        text5: '${_products.length.toString()} share(s)',
                                      ),
                                    ],
                                  );
                                }).toList()
  ...
  void requestNextPage() async {
    ...
    if (!_isRequesting && !_isFinish) {
      ...
      if (_products.isEmpty) {
        ...
        querySnapshot = await FirebaseFirestore.instance.collection('sharedVideos').where('id',isEqualTo: widget.doc['id'])
