...
class ClassSearchStream extends StatefulWidget {
  @override
  _ClassSearchStreamState createState() => _ClassSearchStreamState();
}

class _ClassSearchStreamState extends State<ClassSearchStream> {
