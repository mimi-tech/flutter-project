...
import 'package:sparks/social/socialConstants/SocialSlivers/showAll_tabs.dart';
...
import 'package:sparks/social/usersTabs/course_search.dart';
...
class _CourseTabState extends State<CourseTab> {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            ContentPrice(price: workingDocuments[index]['amt'].toString() ,downloadCount: workingDocuments[index]['dct'].toString() ,),
            VideoText(
              descClick: (){
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(child: Scaffold(
        ...
        body:CustomScrollView(slivers: <Widget>[
          ...
          TabsSearch(title: kSearchBarClass2,tapFunction: (){
            Navigator.push(context, PageTransition(type: PageTransitionType.fade, child: CourseSearchStream()));
  ...
  Future<void> getMyVideos() async {
    ...
    for(int i = 0; i < GlobalVariables.loggedInUserObject.aoi!.length; i++){
      final QuerySnapshot result = await FirebaseFirestore.instance.collectionGroup('userCourses')
    ...
    final QuerySnapshot resultUsers = await FirebaseFirestore.instance.collectionGroup('userCourses')
