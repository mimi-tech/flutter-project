...
import 'package:sparks/social/usersTabs/tutorials_search.dart';
import 'package:video_player/video_player.dart';


class TutorialTab extends StatefulWidget {
  @override
  _TutorialTabState createState() => _TutorialTabState();
}
    ...
    return SafeArea(child: Scaffold(
        ...
        body:CustomScrollView(slivers: <Widget>[
          ...
          ShowAllSliverAppBar(
            matches: kMaincolor,
            friends: kMaincolor,
            classroom: kLightGreen,
            content: kMaincolor,
          ),
          TabsSearch(title: kSearchBarClass3,tapFunction: (){
            Navigator.push(context, PageTransition(type: PageTransitionType.fade, child: TutorialSearchStream()));
                      ...
                      SingleChildScrollView(
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, int index) {
                              ...
                              '${workingDocuments[index]['title']}'.toLowerCase()
