...
import 'package:sparks/social/usersTabs/class_search.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(child: Scaffold(
        ...
        body:CustomScrollView(slivers: <Widget>[
          ...
          TabsSearch(title: kSearchBarClass,tapFunction: (){
            Navigator.push(context, PageTransition(type: PageTransitionType.fade, child: ClassSearchStream()));
