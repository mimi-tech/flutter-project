...
class TutorialSearchStream extends StatefulWidget {
  @override
  _TutorialSearchStreamState createState() => _TutorialSearchStreamState();
}

class _TutorialSearchStreamState extends State<TutorialSearchStream> {
  ...
  initiateSearch(value) {
    ...
    if (queryResultSet.length == 0 && value.length == 1) {
      ...
      SearchService().searchByTutorialTitle(value).then((QuerySnapshot docs) {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(child: Scaffold(
        appBar: SearchAppBar(title: kSearchBarClass3,),
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  VideoText(
                                    descClick: (){
                                      SocialConstant.usersUid =  tempSearchStore[index]['suid']== null?tempSearchStore[index]['eid']:tempSearchStore[index]['suid'];
                                      Navigator.push(context, PageTransition(type: PageTransitionType.fade, child: SocialUserGridView(doc:tempSearchStore[index],)));

                                    },
                                    descFn: tempSearchStore[index]['fn'],
                                    descLn: tempSearchStore[index]['ln'],
                                    descPix: tempSearchStore[index]['pix'],
                                    vido:tempSearchStore[index]['vido'] ,
                                    promo: tempSearchStore[index]['prom'],
                                    thumbnail:  tempSearchStore[index]['tmb'],
                                    show: (){
