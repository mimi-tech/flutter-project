...
import 'package:sparks/social/toReply_comments.dart';
...
bool isOnReply = false;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
        stream: FirebaseFirestore.instance.collection('commentsReplied')
                ...
                children: [
                  ...
                  ListView.builder(
                      ...
                      itemBuilder: (context, int index) {
                        ...
                        text: TextSpan(
                        text: '${workingDocuments[index]['rtfn']} ${workingDocuments[index]['rtln']} ',
                          style: GoogleFonts.rajdhani(
                            fontSize:kFontsize.sp,
                            color: kMaincolor,
                            fontWeight: FontWeight.bold,
                        ...
                        children: <TextSpan>[
                        TextSpan(
                        text: workingDocuments[index]['msg'],
                        style: GoogleFonts.rajdhani(
                        fontSize: kFontsize.sp,
                        color: kBlackcolor,
                        fontWeight: FontWeight.w500,
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                IconButton(icon: Icon(Icons.thumb_up,color:kbtnsecond), onPressed: (){_likeComment(workingDocuments,index);}),
                                            ...
                                            IconButton(icon: Icon(Icons.verified,color:kLightGreen,), onPressed: (){_replyComment(workingDocuments,index);}),
  ...
  Future<void> _likeComment(List<Map<String, dynamic>> workingDocuments, int index) async {
    ...
    FirebaseFirestore.instance.collection('commentsReplied').doc(workingDocuments[index]['id']).get().then((value) {
...
print(workingDocuments[index]['id']);
    showModalBottomSheet(
        ...
        builder: (context) {
          return SocialLikes(doc:workingDocuments[index],cid:workingDocuments[index]['cid']);
        });
  }
...
class _SocialReplyCommentsState extends State<SocialReplyComments> {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text('Reply ${widget.doc!['fn']}'.toUpperCase(),
  ...
  _sendComment()  {
    ...
    try{
      DocumentReference docRef =  FirebaseFirestore.instance.collection('commentsReplied').doc();
      docRef.set({
        'fn':GlobalVariables.loggedInUserObject.nm!['fn'],
        'ln':GlobalVariables.loggedInUserObject.nm!['ln'],
        'pimg':GlobalVariables.loggedInUserObject.pimg,
      ...
      FirebaseFirestore.instance.collection('comments').doc(widget.doc!['id']).get().then((value) {
      ...
      FirebaseFirestore.instance.collection(widget.doc!['sup']).doc(widget.doc!['own']).collection(widget.doc!['sub'])
