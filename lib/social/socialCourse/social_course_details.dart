...
class SocialCourseDetails extends StatefulWidget {
  SocialCourseDetails({required this.doc});
  final DocumentSnapshot doc;

  @override
  _SocialCourseDetailsState createState() => _SocialCourseDetailsState();
}

class _SocialCourseDetailsState extends State<SocialCourseDetails> {
  Widget space(){
           ...
           margin: EdgeInsets.symmetric(horizontal: kHorizontal),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DetailsText(title: 'Course topic',),
                    DetailsContentText(title:'${widget.doc['topic']}'),
                    space(),

                    DetailsText(title: 'Course description',),
                    ...
                    DetailsText(title: 'Course inclusion',),
                    DetailsContentText(title:'${widget.doc['inc']}'),

                    space(),

                    DetailsText(title: 'Course Level',),
                    DetailsContentText(title:'${widget.doc['level']}'),
                    space(),

                    DetailsText(title: 'Course Amount',),
