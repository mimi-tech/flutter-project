...
class _SocialVideoStreamState extends State<SocialVideoStream> {
    ...
    return Card(
      ...
      child: GestureDetector(
        onTap: (){
          ...
          Navigator.pop(context);
          UploadVariables.videoUrlSelected = workingDocuments[index]['prom'];
        ...
        child: Stack(
          // alignment: Alignment.center,
            children: <Widget>[
              ...
              workingDocuments[index]['prom'] == null && workingDocuments[index]['vido'] == null?
              ...
              ClipRRect(
                ...
                child: FadeInImage.assetNetwork(
                  ...
                  height: MediaQuery.of(context).size.height * kSocialVideoCurve3,
                  fit: BoxFit.cover,
                  image: ('${workingDocuments[index]['tmb']}'.toString()),
                  placeholder: 'images/classroom/user.png',),
              ) :


              workingDocuments[index]['tmb'] == null? Container(
                ...
                child: Image.network(workingDocuments[index]['tmb'],
                  fit: BoxFit.cover,
                  width: kSocialVideoCurve4,
                  height: MediaQuery.of(context).size.height * kSocialVideoCurve2,
                ),
              ),
              workingDocuments[index]['prom'] == null && workingDocuments[index]['vido'] == null?Text(''):Align(
  ...
  Future<void> getMyVideos() async {
    ...
    for(int i = 0; i < GlobalVariables.loggedInUserObject.aoi!.length; i++){
      ...
      final QuerySnapshot resultP = await FirebaseFirestore.instance.collectionGroup('publishedLive')
          .where('aoi',arrayContains:  GlobalVariables.loggedInUserObject.aoi![i])
          .orderBy('date',descending: true).limit(SocialConstant.streamLength)
          .get();
      ...
      final QuerySnapshot resultU = await FirebaseFirestore.instance.collectionGroup('userSessionUploads')
          .where('aoi',arrayContains:  GlobalVariables.loggedInUserObject.aoi![i])
    ...
    final QuerySnapshot resultUsers = await FirebaseFirestore.instance.collectionGroup('userSessionUploads')
