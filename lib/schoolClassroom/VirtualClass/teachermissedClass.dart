...
class TeacherMissedClasses extends StatefulWidget {
  @override
  _TeacherMissedClassesState createState() => _TeacherMissedClassesState();
}

class _TeacherMissedClassesState extends State<TeacherMissedClasses> {
                    ...
                    StreamBuilder<List<DocumentSnapshot>>(
                        ...
                        builder: (context, AsyncSnapshot<List<DocumentSnapshot>> snapshot) {
                          if(snapshot.data == null){
                            return Center(child: Text(SchClassConstant.isStudent?kNothing:'Schedule a live class',
                            ...
                            return Column(
                                children: snapshot.data!.map((doc) {
                                  ...
                                  final now = DateTime.parse(data['dd']);
                                  bool checkDateAfter = now.isBefore(DateTime.now());
                                  return checkDateAfter?Column(
                                    children: [
