...
import 'package:sparks/schoolClassroom/VirtualClass/searchAttendedClassesTeacher.dart';
...
class TeachersAttendedEClass extends StatefulWidget {
  @override
  _TeachersAttendedEClassState createState() => _TeachersAttendedEClassState();
}

class _TeachersAttendedEClassState extends State<TeachersAttendedEClass> {
  ...
  void initState() {
    ...
    FirebaseFirestore.instance.collection('savedClasses').doc(SchClassConstant.schDoc['schId']).collection('savedOnlineClasses')
        ...
        child:SafeArea(child: Scaffold(
            ...
            body:CustomScrollView(slivers: <Widget>[
              ...
              EClassSliverAppBarSearch(
                ...
                attendedColor: kIconColor2,
                searchTap: (){
                  Navigator.push(context, PageTransition(type: PageTransitionType.fade, child: SearchStudentAttendedClasses()));
