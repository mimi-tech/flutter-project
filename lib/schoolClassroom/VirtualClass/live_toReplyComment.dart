...
class LiveToReplyComment extends StatefulWidget {
  LiveToReplyComment({required this.doc});
  final Map<String, dynamic> doc;

  @override
  _LiveToReplyCommentState createState() => _LiveToReplyCommentState();
}

class _LiveToReplyCommentState extends State<LiveToReplyComment> {
