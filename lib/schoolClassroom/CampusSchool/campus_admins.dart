...
class CampusAddShowAdmin extends StatefulWidget {
  @override
  _CampusAddShowAdminState createState() => _CampusAddShowAdminState();
}

class _CampusAddShowAdminState extends State<CampusAddShowAdmin> {
  Widget space(){
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      CampusSliverAppBar(
        ...
        adminsBgColor: klistnmber,
        adminsColor: kWhitecolor,
      ),
                    ...
                    StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                        ...
                        builder: (context, snapshot) {
                          if (snapshot.connectionState == ConnectionState.waiting) {
                            ...
                            //final List<DocumentSnapshot> workingDocuments = snapshot.data!.documents as List<Map<String, dynamic>>;
