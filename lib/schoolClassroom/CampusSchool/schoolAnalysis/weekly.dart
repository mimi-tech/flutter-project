...
class WeeklyTeachersAnalysis extends StatefulWidget {
  WeeklyTeachersAnalysis({required this.doc});
  final DocumentSnapshot doc;
  @override
  _WeeklyTeachersAnalysisState createState() => _WeeklyTeachersAnalysisState();
}

class _WeeklyTeachersAnalysisState extends State<WeeklyTeachersAnalysis> {
          ...
          ListView.builder(
              ...
              itemBuilder: (context, int index) {
                return ACardConstruct(
                  text6: 'Week ${ workingDocuments[index]['wk']} / ${workingDocuments[index]['yr']}'.toString(),
  ...
  void getDailyAnalysis() {
    try{
      FirebaseFirestore.instance.collectionGroup('weeklyTeachersAnalysis')
