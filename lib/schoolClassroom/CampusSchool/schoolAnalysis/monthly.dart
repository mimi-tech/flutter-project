...
class MonthlyTeachersAnalysis extends StatefulWidget {
  MonthlyTeachersAnalysis({required this.doc});
  final DocumentSnapshot doc;
  @override
  _MonthlyTeachersAnalysisState createState() => _MonthlyTeachersAnalysisState();
}

class _MonthlyTeachersAnalysisState extends State<MonthlyTeachersAnalysis> {
          ...
          ListView.builder(
              ...
              itemBuilder: (context, int index) {
                ...
                return ACardConstruct(
                  text6: '${ DateFormat('MMMM').format(DateTime(0, workingDocuments[index]['mth']))} / ${workingDocuments[index]['yr']}'.toString(),
  ...
  void getDailyAnalysis() {
    try{
      FirebaseFirestore.instance.collectionGroup('monthlyTeachersAnalysis')
