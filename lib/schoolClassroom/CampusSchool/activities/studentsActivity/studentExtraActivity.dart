...
class StudentExtraCurriculaActivities extends StatefulWidget {
  StudentExtraCurriculaActivities({required this.doc});
  final DocumentSnapshot doc;
  @override
  _StudentExtraCurriculaActivitiesState createState() => _StudentExtraCurriculaActivitiesState();
}

class _StudentExtraCurriculaActivitiesState extends State<StudentExtraCurriculaActivities> {
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: Text('This student watched these Extra curricula lessons'.toUpperCase(),
