...
class CampusSearchTutors extends StatefulWidget {
  CampusSearchTutors({required this.level});
  final String level;
  @override
  _CampusSearchTutorsState createState() => _CampusSearchTutorsState();
}

class _CampusSearchTutorsState extends State<CampusSearchTutors> {
  Widget space(){
  ...
  Widget build(BuildContext context) {
    return NotificationListener<ScrollNotification>(
        ...
        child: SafeArea(
            child: Scaffold(
                appBar:CampusDeptAppbar(name: widget.level,),
                      ...
                      Container(
                          child: Column(
                              children: [
                                ...
                                space(),
                                Text('Tutors List for ${widget.level} department'.toUpperCase(),
