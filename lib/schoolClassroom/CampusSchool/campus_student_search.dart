...
class CampusStudentSearchStream extends StatefulWidget {
  @override
  _CampusStudentSearchStreamState createState() => _CampusStudentSearchStreamState();
}

class _CampusStudentSearchStreamState extends State<CampusStudentSearchStream> {
  ...
  initiateSearch(value) {
    ...
    if (queryResultSet.length == 0 && value.length == 1) {
      ...
      SchClassConstant().searchByStudentName(value).then((QuerySnapshot docs) {
                                    ...
                                    child:Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          space(),
                                          ShowRichText(color:kExpertColor,title: 'Student department: ',titleText: tempSearchStore[index]['dept']),

                                          space(),
                                          ShowRichText(color:kExpertColor,title: 'Student faculty: ',titleText: tempSearchStore[index]['fac']),
