...
class SeeTeachersReport extends StatefulWidget {
  @override
  _SeeTeachersReportState createState() => _SeeTeachersReportState();
}

class _SeeTeachersReportState extends State<SeeTeachersReport> {
  ...
  Future<void> getAnnouncement() async {
    ...
    final QuerySnapshot result = await FirebaseFirestore.instance
        .collection("tutorsReport").doc(SchClassConstant.schDoc['schId']).collection('report')
         .where('id',isEqualTo: SchClassConstant.schDoc['id'])
