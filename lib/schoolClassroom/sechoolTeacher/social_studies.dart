...
class TeacherSocialStudies extends StatefulWidget {
  @override
  _TeacherSocialStudiesState createState() => _TeacherSocialStudiesState();
}

class _TeacherSocialStudiesState extends State<TeacherSocialStudies> {
  ...
  void requestNextPage() async {
    ...
    if (!_isRequesting && !_isFinish) {
      ...
      if (_products.isEmpty) {
        ...
        querySnapshot = await   FirebaseFirestore.instance.collectionGroup('schoolSocials')
            .where('tId',isEqualTo:  SchClassConstant.schDoc['id'])
            .where('schId',isEqualTo:  SchClassConstant.schDoc['schId'])
            .where('tsl',isEqualTo:  SchClassConstant.schDoc['lv'])
            .where('tcl',isEqualTo:  SchClassConstant.schDoc['cl'])
