...
class TeachersSocialFeedback extends StatefulWidget {
  TeachersSocialFeedback({required this.doc});
  final DocumentSnapshot doc;
  @override
  _TeachersSocialFeedbackState createState() => _TeachersSocialFeedbackState();
}

class _TeachersSocialFeedbackState extends State<TeachersSocialFeedback> {
  bool progress = false;
  ...
  Future<void> getSchoolDetails() async {
    ...
    final QuerySnapshot result = await FirebaseFirestore.instance.collection('socialClassFeedback').doc(widget.doc['schId']).collection('socialFeedback')
