...
class SchoolReplyComments extends StatefulWidget {
  SchoolReplyComments({required this.doc});
  final DocumentSnapshot? doc;

  @override
  _SchoolReplyCommentsState createState() => _SchoolReplyCommentsState();
}

class _SchoolReplyCommentsState extends State<SchoolReplyComments> {
  ...
  Future<void> _likeComment(
    ...
    if (documents.length == 0) {
      //increase the number of like for the replied comment
      FirebaseFirestore.instance
          .collection('schoolCommentsReplied')
...
class SchoolPostReplyComments extends StatefulWidget {
  SchoolPostReplyComments({required this.doc});
  final DocumentSnapshot? doc;
  @override
  _SchoolPostReplyCommentsState createState() =>
      _SchoolPostReplyCommentsState();
}

class _SchoolPostReplyCommentsState extends State<SchoolPostReplyComments> {
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: <Widget>[
            ...
            SchoolReplyComments(doc: widget.doc),
            Container(
