...
class SchoolProfilePosts extends StatefulWidget {
  @override
  _SchoolProfilePostsState createState() => _SchoolProfilePostsState();
}

class _SchoolProfilePostsState extends State<SchoolProfilePosts> {
  bool progress = false;
      ...
      Column(
        ...
        children: [
          ...
          workingDocuments.length == 0 && progress == true ?Center(
            child: Text('Your school have not made any post',
