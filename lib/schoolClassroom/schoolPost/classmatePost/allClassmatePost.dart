...
class AllClassmatePostVideos extends StatefulWidget {
  @override
  _AllClassmatePostVideosState createState() => _AllClassmatePostVideosState();
}

class _AllClassmatePostVideosState extends State<AllClassmatePostVideos> {
  bool progress = false;
