...
import 'package:sparks/schoolClassroom/schoolPost/classmatePost/allClassmatePost.dart';
...
class ClassmateHorizontalVideoPosts extends StatefulWidget {
  @override
  _ClassmateHorizontalVideoPostsState createState() =>
      _ClassmateHorizontalVideoPostsState();
}

class _ClassmateHorizontalVideoPostsState
    extends State<ClassmateHorizontalVideoPosts> {
  bool progress = false;
                                                  ...
                                                  Container(
                                                    constraints: BoxConstraints(
                                                        maxWidth: MediaQuery.of(
                                                            ...
                                                            kStuPostTextW),
                                                    child: Text(
                                                      '${workingDocuments[index]['dept']} department',
                                                      maxLines: 1,
                                                      overflow:
                                                      TextOverflow
                                                          .ellipsis,
