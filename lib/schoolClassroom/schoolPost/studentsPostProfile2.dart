...
import 'package:sparks/schoolClassroom/schoolPost/postListItems.dart';
...
class CampusPostScreenSecond extends StatefulWidget {
  @override
  _CampusPostScreenSecondState createState() => _CampusPostScreenSecondState();
}

class _CampusPostScreenSecondState extends State<CampusPostScreenSecond> {
  bool progress = false;
    ...
    return
            Column(
              ...
              children: [
                ...
                workingDocuments.length == 0 && progress == true ?Text('No Post has been posted'):
                ListView.builder(
                              ...
                              children: [
                                ...
                                IconButton(icon: Icon(Icons.more_vert), onPressed: (){
                                  showModalBottomSheet(
                                      context: context,
                                      builder: (context) => StudentPostListItems(doc:_documents[index]));
                                })
                              ],
                            ),
  ...
  Future<void> getStudentPosts() async {
    ...
    FirebaseFirestore.instance.collection('schoolPost').doc(SchClassConstant.schDoc['schId']).collection('campusPost')
        .where('stId',isEqualTo: SchoolPostConst.doc['stId'])
