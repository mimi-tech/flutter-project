...
class StudentsLikePost extends StatefulWidget {
  StudentsLikePost({required this.doc});
  final DocumentSnapshot doc;
  @override
  _StudentsLikePostState createState() => _StudentsLikePostState();
}

class _StudentsLikePostState extends State<StudentsLikePost> {
  @override
