...
class ReportIMade extends StatefulWidget {
  @override
  _ReportIMadeState createState() => _ReportIMadeState();
}

class _ReportIMadeState extends State<ReportIMade> {
  var _documents = [];
  ...
  Future<void> getAnnouncement() async {
    ...
    final QuerySnapshot result = await FirebaseFirestore.instance
        ...
        .where('rId', isEqualTo: SchClassConstant.schDoc['id'])
