...
import 'package:sparks/schoolClassroom/utils/testSlider.dart';
import 'package:timeago/timeago.dart' as timeago;
import 'package:video_player/video_player.dart';

class CampusPostScreen extends StatefulWidget {
  @override
  _CampusPostScreenState createState() => _CampusPostScreenState();
}
          ...
          children: [
            ...
            SizedBox(
              ...
              child: Swiper(
                ...
                onTap: (int){
                  indexNumber = int;
                  imageSrc = workingDocuments[index]['pix'][int];
                },
              ),
            )
              ...
              children: [
                ...
                GestureDetector(
                  onTap:(){
                    ...
                    Navigator.push(context, PageTransition(type: PageTransitionType.rightToLeft, child: ShowingSlide()));
