...
class StudentFeedback extends StatefulWidget {
  StudentFeedback({required this.doc});
...
class _StudentFeedbackState extends State<StudentFeedback> {
                ...
                child: Column(
                    children: [
                      ...
                      Form(
                        ...
                        child: Column(
                          children: [
                            Text('Give your teacher a feedback concerning this lesson: ${widget.doc['title']}',
  ...
  Future<void> verifyUn() async {
    ...
    if (form.validate()) {
      ...
      try{
        final QuerySnapshot result = await FirebaseFirestore.instance.collectionGroup('feedback')
        ...
        if (documents.length == 0) {
            ...
            FirebaseFirestore.instance.collection('lesson').doc(widget.doc['schId']).collection('schoolLessons').doc(widget.doc['id']).get()
                .then((resultComm) {
