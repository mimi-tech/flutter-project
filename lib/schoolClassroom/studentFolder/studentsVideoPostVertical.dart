...
class StudentVideoPostsVertical extends StatefulWidget {
  StudentVideoPostsVertical({required this.doc});
  final DocumentSnapshot doc;
  @override
  _StudentVideoPostsVerticalState createState() => _StudentVideoPostsVerticalState();
}

class _StudentVideoPostsVerticalState extends State<StudentVideoPostsVertical> {
  bool progress = false;
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: workingDocuments.length == 0 && progress == false ?Center(child: CircularProgressIndicator(backgroundColor: kFbColor,)):
        workingDocuments.length == 0 && progress == true ?Text('No video has been posted'): SingleChildScrollView(
          child: Column(
            children: [
              ListView.builder(
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text('${workingDocuments[index]['dept']}'.toUpperCase(),
                                      style: GoogleFonts.rajdhani(
