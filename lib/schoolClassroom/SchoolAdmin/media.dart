...
class CreateHighSchoolPost extends StatefulWidget {
  @override
  _CreateHighSchoolPostState createState() => _CreateHighSchoolPostState();
}

class _CreateHighSchoolPostState extends State<CreateHighSchoolPost> {
  Widget space() {
    return SizedBox(
