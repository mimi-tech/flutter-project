...
import 'package:sparks/schoolClassroom/SchoolAdmin/search_studies.dart';
...
class AdminStudies extends StatefulWidget {
  @override
  _AdminStudiesState createState() => _AdminStudiesState();
}

class _AdminStudiesState extends State<AdminStudies> {
  ...
  void initState() {
    ...
    FirebaseFirestore.instance.collectionGroup('schoolLessons').where('schId',isEqualTo:  SchClassConstant.schDoc['schId']).orderBy('ts',descending: true)
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                TeacherShowText(
                                                    ...
                                                    date: DateFormat('yyyy-MM-dd hh:mm:a').format(DateTime.parse(data['ts'])),
  ...
  void requestNextPage() async {
    ...
    if (!_isRequesting && !_isFinish) {
      ...
      if (_products.isEmpty) {
        ...
        querySnapshot = await   FirebaseFirestore.instance.collectionGroup('schoolLessons').where('schId',isEqualTo:  SchClassConstant.schDoc['schId']).orderBy('ts',descending: true)
