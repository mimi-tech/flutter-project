...
class AdminTeachersFeedback extends StatefulWidget {
  AdminTeachersFeedback({required this.doc});
  final DocumentSnapshot doc;
  @override
  _AdminTeachersFeedbackState createState() => _AdminTeachersFeedbackState();
}

class _AdminTeachersFeedbackState extends State<AdminTeachersFeedback> {
                ...
                child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text("Tutors feedback".toUpperCase(),
                      ...
                      Form(
                        ...
                        child: Column(
                          children: [
                            Text('What did you find out concerning this lesson: ${widget.doc['title']}',
...
print('ppppppppp');
     try{
          ...
          DocumentReference ref = FirebaseFirestore.instance.collection('lessonFeedback').doc(widget.doc['schId']).collection('feedback').doc();
          ref.set({
            'id':widget.doc['id'],
      ...
      SchClassConstant.displayToastCorrect(title: kSchoolStudentFee2);
