...
class AllStudiesSearchStream extends StatefulWidget {
  @override
  _AllStudiesSearchStreamState createState() => _AllStudiesSearchStreamState();
}

class _AllStudiesSearchStreamState extends State<AllStudiesSearchStream> {
  ...
  initiateSearch(value) {
    ...
    if (queryResultSet.length == 0 && value.length == 1) {
      ...
      SchClassConstant().searchByStudiesName(value).then((QuerySnapshot docs) {
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            TeacherShowText(
                                                ...
                                                downloads: tempSearchStore[index]['down'].toString(),
                                                note: tempSearchStore[index]['ntc'].toString()
