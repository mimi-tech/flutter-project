...
import 'package:sparks/schoolClassroom/SchoolAdmin/non_campus_newsTab.dart';
...
class NotCampusAdminBottomBar extends StatefulWidget {
  NotCampusAdminBottomBar({
  ...
  @override
  _NotCampusAdminBottomBarState createState() => _NotCampusAdminBottomBarState();
}

class _NotCampusAdminBottomBarState extends State<NotCampusAdminBottomBar> {
  @override
            ...
            children: [
              GestureDetector(
                onTap: (){
                  ...
                  Navigator.push (context, PageTransition (type: PageTransitionType.bottomToTop, child: CreateDepartment()));
                },
                child: Column(
              ...
              GestureDetector(
                onTap: (){
                  ...
                  Navigator.push (context, PageTransition (type: PageTransitionType.bottomToTop, child: NonCampusNewsTab()));
              ...
              GestureDetector(
                onTap: (){
                  Navigator.push (context, PageTransition (type: PageTransitionType.bottomToTop, child: CampusRecordTab()));
                },
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  ...
                  children: [
                    ...
                    Text('Records',//kSchoolStudentStudies,
                      style: GoogleFonts.rajdhani(
                        textStyle: TextStyle(
                          fontWeight: FontWeight.w500,
                          color: kWhitecolor,
