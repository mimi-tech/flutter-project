...
import 'package:sparks/schoolClassroom/utils/reply_comments.dart';
...
class _SocialCommentsState extends State<SocialComments> {
  ...
  Future<void> _likeComment(
      List<DocumentSnapshot?> workingDocuments, int index) async {
  ...
  void _replyComment(List<DocumentSnapshot?> workingDocuments, int index) {
    Navigator.push(
        ...
        PageTransition(
            ...
            child: SocialReplyComments(doc: workingDocuments[index])));
  }
