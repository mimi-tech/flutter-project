                    ...
                    Row(
                      ...
                      children: [
                        Row(
                          children: [
                            IconButton(
                                icon: Icon(Icons.timer, color: kbtnsecond),
                                onPressed: () {}),
                            Text(
                              '${timeago.format(DateTime.parse(widget.doc!['ts']), locale: 'en_short')}',
                              style: GoogleFonts.rajdhani(
                                textStyle: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  color: klistnmber,
                        ...
                        Row(
                          children: [
                            IconButton(
                                icon: Icon(Icons.thumb_up, color: kbtnsecond),
                                onPressed: () {}),
                            Text(
                              '${widget.doc!['like']}',
                              style: GoogleFonts.rajdhani(
                        ...
                        Row(
                          children: [
                            IconButton(
                                icon: Icon(Icons.reply, color: kbtnsecond),
                                onPressed: () {}),
                            Text(
                              '${widget.doc!['re']}',
                              style: GoogleFonts.rajdhani(
