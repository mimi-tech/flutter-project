...
import 'package:sparks/company/country.dart';
import 'package:sparks/company/screens/fourth_screen.dart';
import 'package:sparks/company/state.dart';
...
class _ThirdScreenState extends State<ThirdScreen>
  ...
  void goToNext() {
    if (Constants.selectedCountry == null) {
      ...
      Fluttertoast.showToast(
          msg: 'Please give us your company logo',
          toastLength: Toast.LENGTH_LONG,
          backgroundColor: kBlackcolor,
          textColor: kFbColor);
    } else {
