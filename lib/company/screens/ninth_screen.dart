...
class _NinthScreenState extends State<NinthScreen>
  ...
  void initState() {
    ...
    Future(() async {
      ...
      Constants.companyCurrentUser = currentUser.uid;
    });
    Future(() async {
          ...
          child: Container(
            ...
            child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                stream: FirebaseFirestore.instance
                    .collection('users')
                    .doc(Constants.companyCurrentUser)
                    .collection('company')
                    .snapshots(),
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    final List<Map<String, dynamic>> testingOne =
                        ...
                        children: <Widget>[
                          Stack(
                            children: <Widget>[
                              ...
                              Container(
                                margin:
                                    EdgeInsets.symmetric(vertical: kComspace),
