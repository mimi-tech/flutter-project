...
import 'package:sparks/app_entry_and_home/sparks_enums/be_a_mentor.dart';
import 'package:sparks/app_entry_and_home/static_variables/static_variables.dart';
import 'package:sparks/app_entry_and_home/strings/strings.dart';

class WantToBeAMentor extends StatefulWidget {
  ...
  @override
  _WantToBeAMentorState createState() => _WantToBeAMentorState();
}

class _WantToBeAMentorState extends State<WantToBeAMentor>
    with TickerProviderStateMixin {
  bool isAMentor = false;
  late AnimationController _controller;
  late Animation<Offset> offset;
  Animation<double>? _fadeAnimation;
  BeAMentor _beAMentor = BeAMentor.NONE;
  String status = "";
                    ...
                    SlideTransition(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          children: <Widget>[
                            //TODO: Display the label: Want to be a mentor or not.
                            Center(
                              child: Text(
                                kBeAMentorOrNot,
                            ...
                            //TODO: Choose if you want to be a mentor or not.
                            Center(
                              child: Container(
                                width: MediaQuery.of(context).size.width,
                                height:
                                      ...
                                      child: Container(
                                        ...
                                        height:
                                            MediaQuery.of(context).size.height *
                                                0.07,
                                        decoration: BoxDecoration(
                                          color: _beAMentor == BeAMentor.MENTOR
                                              ? kProfile
                                              : kTransparent,
                                          borderRadius:
                                      ...
                                      child: Container(
                                        ...
                                        height:
                                            MediaQuery.of(context).size.height *
                                                0.07,
                                        decoration: BoxDecoration(
                                          color: _beAMentor == BeAMentor.FRIEND
                                              ? kProfile
                                              : kTransparent,
                                          borderRadius:
                                              BorderRadius.circular(5.0),
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            ...
                            child: GestureDetector(
                              onTap: () async {
                                //TODO: Check if is a mentor field is empty.
                                if (_beAMentor == BeAMentor.NONE) {
                                  //TODO; Display a toast.
                                  Fluttertoast.showToast(
                                      msg: kWant_be_A_Mentor,
                                  ...
                                  //TODO: Store user's choice of becoming a mentor or not.
                                  GlobalVariables.amAMentor = isAMentor;

                                  setState(() {
                                    //TODO: Store the account status of this user.
                                    GlobalVariables.accountStatus = status;
