...
class PersonalReg5 extends StatefulWidget {
  ...
  @override
  _PersonalReg5State createState() => _PersonalReg5State();
}

class _PersonalReg5State extends State<PersonalReg5>
  ...
  void initState() {
    ...
    lastNameController.addListener(_lastNameListener);
    fN = FocusNode();
    super.initState();
  }
                    ...
                    SlideTransition(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          children: <Widget>[
                            //TODO: Display the label: Enter your last name.
                            Center(
                              child: Text(
                                kEnter_ln,
                            ...
                            child: GestureDetector(
                              onTap: () async {
                                ...
                                if ((lastName.trim() == null) ||
                                  ...
                                  //TODO: Store user's last name.
                                  GlobalVariables.lastName = lastName.trim();

                                  setState(() {
                                    fN!.unfocus();
                                    //TODO: Go to the sixth page (Personal Account)
