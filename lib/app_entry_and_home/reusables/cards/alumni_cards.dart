              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                    color:
                        fromYearPostG == "From" ? kButton_disabled : kProfile,
                ...
                Container(
                  ...
                  height: MediaQuery.of(context).size.height * 0.045,
                  decoration: BoxDecoration(
                    color: toYearPostG == "To" ? kButton_disabled : kProfile,
                    borderRadius: BorderRadius.circular(5.0),
                  ),
                  //TODO: To when.
                  child: Row(
                      ...
                      GestureDetector(
                        onTap: () async {
                          ...
                          setState(() {
                            ...
                            fromTo.add(fromYearPostG);
                            fromTo.add(toYearPostG);

                            //TODO: Store the map in a shared preference.
                            prefs.setStringList(
                                "postgrad", fromTo as List<String>);
                          });
                        },
                        child: Icon(
                          Icons.date_range,
