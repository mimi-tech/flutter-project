...
class CompanyCountry extends StatefulWidget {
  @override
  _CompanyCountryState createState() => _CompanyCountryState();
}

class _CompanyCountryState extends State<CompanyCountry>
          ...
          child: Padding(
            ...
            child: SlideTransition(
              ...
              child: Align(
                ...
                child: Text(
                  Constants.selectedCountry == null
                      ? kCcompanylocated
                      : "Ellis here", //Variables.country
                  style: TextStyle(
                    fontSize: 20.sp,
                  ...
                  children: <Widget>[
                    Column(
                      children: <Widget>[
                        ...
                        //     setState(
                        //       () {
                        //         Constants.selectedCountry = Variables.country;
