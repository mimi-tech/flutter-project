...
class SchoolPinScreen extends StatefulWidget {
  @override
  _SchoolPinScreenState createState() => _SchoolPinScreenState();
}

class _SchoolPinScreenState extends State<SchoolPinScreen> {
