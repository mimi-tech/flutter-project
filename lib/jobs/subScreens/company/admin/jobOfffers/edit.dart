...
class EditJobOffer extends StatefulWidget {
  @override
  _EditJobOfferState createState() => _EditJobOfferState();
}
...
class _EditJobOfferState extends State<EditJobOffer> {
  ...
  void validateAndUpdateData() {
    if (_companyNameController.text == '') {
      ...
      DocumentReference documentReference = FirebaseFirestore.instance
          ...
          .doc(JobOfferFormStorage.mainCompanyId)
  ...
  void initState() {
    ...
    _jobTitleController.text = JobOfferFormStorage.jobTitle!;
    _jobOfferDescriptionController.text = JobOfferFormStorage.description!;
    _jobSalaryController.text = JobOfferFormStorage.salaryRangeMax!;
    _jobOfferMessage.text = JobOfferFormStorage.jobOfferMessage!;
  }
