...
class UploadPortfolioInsight extends StatefulWidget {
  @override
  _UploadPortfolioInsightState createState() => _UploadPortfolioInsightState();
}

class _UploadPortfolioInsightState extends State<UploadPortfolioInsight> {
...
// Points to 'image'
  ...
  void addInsight() {
    ...
    if (isInsightImageUploadComplete == false) {
      ...
      Fluttertoast.showToast(
          msg: "Insight title field cannot be blank",
          toastLength: Toast.LENGTH_SHORT,
          backgroundColor: Colors.red,
          textColor: Colors.white);
    } else if (categoryContentController.text == '') {
      Fluttertoast.showToast(
          msg: "Insight content field cannot be blank",
          toastLength: Toast.LENGTH_SHORT,
          backgroundColor: Colors.red,
          textColor: Colors.white);
    } else {
        ...
        body: ModalProgressHUD(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                for (var i = 0; i < listInsights.length; i++)
                  Column(
                    children: [
                      Container(
                        child: CircleAvatar(
                          ...
                          child: ClipOval(
                            child: CachedNetworkImage(
                              imageUrl: listInsights.elementAt(i)['image'],
                      ...
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            listInsights.elementAt(i)['insightTitle'],
                      ...
                      Container(
                        ...
                        padding: const EdgeInsets.all(3.0),
                        child: Text(
                          listInsights.elementAt(i)['insightDescription'],
                          style: GoogleFonts.rajdhani(
                            textStyle: TextStyle(
