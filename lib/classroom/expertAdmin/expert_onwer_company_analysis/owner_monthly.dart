...
class ExpertCompanyMonthlyAnalysis extends StatefulWidget {
  @override
  _ExpertCompanyMonthlyAnalysisState createState() =>
      _ExpertCompanyMonthlyAnalysisState();
}

class _ExpertCompanyMonthlyAnalysisState
    extends State<ExpertCompanyMonthlyAnalysis> {
  Widget space() {
    return SizedBox(
                    ...
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      return Column(children: <Widget>[
                        ...
                        ExpertCompanyAnalysisCount(
                          name: months[currentMon - 1].toString().toUpperCase(),
                                      ...
                                      children: <Widget>[
                                        ...
                                        Row(children: <Widget>[
                                          Container(
                                              ...
                                              child: Center(
                                                child: Text(
                                                  '${workingDocuments[index]['vfm'].toString()}',
                                                  style: GoogleFonts.rajdhani(
                                                    fontSize: kFontsize.sp,
                                                    color: kBlackcolor,
                                                    fontWeight: FontWeight.w500,
