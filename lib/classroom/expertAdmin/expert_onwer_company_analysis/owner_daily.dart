...
class OnwerCompanyDailyAnalysis extends StatefulWidget {
  @override
  _OnwerCompanyDailyAnalysisState createState() =>
      _OnwerCompanyDailyAnalysisState();
}

class _OnwerCompanyDailyAnalysisState extends State<OnwerCompanyDailyAnalysis> {
  Widget space() {
    return SizedBox(
