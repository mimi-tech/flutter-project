...
class YearlyClassesAnalysis extends StatefulWidget {
  @override
  _YearlyClassesAnalysisState createState() => _YearlyClassesAnalysisState();
}

class _YearlyClassesAnalysisState extends State<YearlyClassesAnalysis> {
  Widget space() {
    return SizedBox(
