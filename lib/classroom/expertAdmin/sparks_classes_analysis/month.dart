...
class MonthlyClassesAnalysis extends StatefulWidget {
  @override
  _MonthlyClassesAnalysisState createState() => _MonthlyClassesAnalysisState();
}

class _MonthlyClassesAnalysisState extends State<MonthlyClassesAnalysis> {
  Widget space() {
    return SizedBox(
