...
class ExpertAnalysisCount extends StatefulWidget {
  ExpertAnalysisCount(
  ...
  final String name;
  @override
  _ExpertAnalysisCountState createState() => _ExpertAnalysisCountState();
}

class _ExpertAnalysisCountState extends State<ExpertAnalysisCount> {
  @override
