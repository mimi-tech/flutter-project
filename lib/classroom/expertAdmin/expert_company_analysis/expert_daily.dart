...
class ExpertCompanyDailyAnalysis extends StatefulWidget {
  @override
  _ExpertCompanyDailyAnalysisState createState() =>
      _ExpertCompanyDailyAnalysisState();
}

class _ExpertCompanyDailyAnalysisState
    extends State<ExpertCompanyDailyAnalysis> {
  Widget space() {
    return SizedBox(
