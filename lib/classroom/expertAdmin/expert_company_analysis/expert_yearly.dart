...
class ExpertCompanyYearlyAnalysis extends StatefulWidget {
  @override
  _ExpertCompanyYearlyAnalysisState createState() =>
      _ExpertCompanyYearlyAnalysisState();
}

class _ExpertCompanyYearlyAnalysisState
    extends State<ExpertCompanyYearlyAnalysis> {
  Widget space() {
    return SizedBox(
                                        ...
                                        children: <Widget>[
                                          ...
                                          Row(children: <Widget>[
                                            Container(
                                                ...
                                                child: Center(
                                                  child: Text(
                                                    '${workingDocuments[index]['vfy'].toString()}',
                                                    style: GoogleFonts.rajdhani(
                                                      fontSize: kFontsize.sp,
                                                      color: kBlackcolor,
                                                      fontWeight:
