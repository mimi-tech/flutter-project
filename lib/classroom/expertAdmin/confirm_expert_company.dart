...
class ConfirmExpertCompany extends StatefulWidget {
  ConfirmExpertCompany({this.name, this.id, this.docs});
  final String? name;
  final String? id;
  final List<dynamic>? docs;
  @override
  _ConfirmExpertCompanyState createState() => _ConfirmExpertCompanyState();
}

class _ConfirmExpertCompanyState extends State<ConfirmExpertCompany> {
