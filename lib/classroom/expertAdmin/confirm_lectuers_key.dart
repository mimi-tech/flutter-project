...
import 'package:sparks/classroom/expertAdmin/generate_lecture_key.dart';
...
class ConfirmLecturesKey extends StatefulWidget {
  @override
  _ConfirmLecturesKeyState createState() => _ConfirmLecturesKeyState();
}

class _ConfirmLecturesKeyState extends State<ConfirmLecturesKey> {
                        ...
                        RaisedButton(
                          ...
                          onPressed: () {
                            ...
                            showModalBottomSheet(
                                ...
                                context: context,
                                builder: (context) => GenerateLecturerKey());
                          },
                          child: Text(
                            'Proceed',
                            style: GoogleFonts.rajdhani(
        ...
        try {
          ...
          if (documents.length == 0) {
            ...
            for (DocumentSnapshot doc in documents) {
              ...
              setState(() {
                ExpertAdminConstants.lecturesKey = doc;
                fName = data!['nm']['fn'];
                // fName = data['nm']['fn'];
                lName = data['nm']['ln'];
                // lName = data['nm']['ln'];
