...
class SeeExpert extends StatefulWidget {
  SeeExpert({required this.index, required this.doc});
  final List<dynamic> doc;
  final int index;
  @override
  _SeeExpertState createState() => _SeeExpertState();
}

class _SeeExpertState extends State<SeeExpert> {
  bool progress = false;
  var itemsData = [];
  var _documents = [];
                        ...
                        child: SingleChildScrollView(
                          child: Padding(
                            ...
                            child: Column(children: [
                              ...
                              Text(
                                '${widget.doc[widget.index]['name']} Expert'
                                    .toUpperCase(),
