...
import 'package:sparks/classroom/sparksCompanies/courses/c_staff.dart';
...
class CrCompanies extends StatefulWidget {
  @override
  _CrCompaniesState createState() => _CrCompaniesState();
}

class _CrCompaniesState extends State<CrCompanies> {
  bool progress = false;
  var itemsData = [];
  var _documents = [];
        ...
        child: Scaffold(
            body: itemsData.length == 0 && progress == false
                ...
                : itemsData.length == 0 && progress == true
                    ? NoContentCreated(
                        title: 'No  company have been registered for courses',
                      )
                    : Column(
                        children: [
                          ListView.builder(
  ...
  void _seeStaff(int index) {
    showModalBottomSheet(
        ...
        context: context,
        builder: (context) => SeeCourseStaff(index: index, doc: itemsData));
  }
