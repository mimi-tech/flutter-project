...
class SeeCourseStaff extends StatefulWidget {
  SeeCourseStaff({required this.index, required this.doc});
  final List<dynamic> doc;
  final int index;
  @override
  _SeeCourseStaffState createState() => _SeeCourseStaffState();
}

class _SeeCourseStaffState extends State<SeeCourseStaff> {
  bool progress = false;
  var itemsData = [];
  var _documents = [];
