...
import 'package:sparks/classroom/courses/course_description3.dart';
...
class CourseDescriptionSecond extends StatefulWidget {
  @override
  _CourseDescriptionSecondState createState() =>
      _CourseDescriptionSecondState();
}
  ...
  void _nextBtn() {
    ...
    if (SelectedLanguage.data.isEmpty) {
      ...
      Navigator.of(context).push(
          MaterialPageRoute(builder: (context) => CourseDescriptionThird()));
    }
  }
}
