...
import 'package:sparks/classroom/expert_class/expert_admin.dart';
...
class ExpertKey extends StatefulWidget {
  @override
  _ExpertKeyState createState() => _ExpertKeyState();
}

class _ExpertKeyState extends State<ExpertKey> with TickerProviderStateMixin {
        ...
        await FirebaseFirestore.instance
          ...
          value.docs.forEach((result) {
            setState(() {
              ...
              ExpertConstants.expertKey.add(result.data());
            });
          });
        });
        if (key == myKey) {
          ...
          Navigator.of(context).pushReplacement(
              MaterialPageRoute(builder: (context) => ExpertAdminKey()));
        } else {
          setState(() {
            progress = false;
          });
