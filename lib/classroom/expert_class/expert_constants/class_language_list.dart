...
class ClassLanguageList extends StatefulWidget {
  @override
  _ClassLanguageListState createState() => _ClassLanguageListState();
}

class _ClassLanguageListState extends State<ClassLanguageList> {
  var selected = [];
  ...
  void showList(BuildContext context, String language, int index) {
    if (selected.contains(index)) {
      setState(() {
        ...
        ExpertConstants.language.remove(language);
      });
    } else {
      setState(() {
        selected.add(index);
        ExpertConstants.language.add(language);
      });
    }
  }
}
