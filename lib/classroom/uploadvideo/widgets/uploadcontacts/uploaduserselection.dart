...
class UploadUserSelections extends StatefulWidget {
  @override
  _UploadUserSelectionsState createState() => _UploadUserSelectionsState();
}

class _UploadUserSelectionsState extends State<UploadUserSelections> {
  var items = [];
