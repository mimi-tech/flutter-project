...
class ConfirmCourseCompany extends StatefulWidget {
  ConfirmCourseCompany({this.name, this.id, this.docs});
  final String? name;
  final String? id;
  final List<dynamic>? docs;
  @override
  _ConfirmCourseCompanyState createState() => _ConfirmCourseCompanyState();
}

class _ConfirmCourseCompanyState extends State<ConfirmCourseCompany> {
          ...
          child: getUser == true
              ? Column(
                  children: <Widget>[
                    ...
                    spacer(),
                    Text(
                      'Do you want to create company for',
              ...
              : Column(
                  children: <Widget>[
                    ...
                    spacer(),
                    Text(
                      'Please enter email of the company owner'.toUpperCase(),
