...
class ConfirmAdmin extends StatefulWidget {
  ConfirmAdmin({required this.name, required this.id});
  final String? name;
  final String? id;
  @override
  _ConfirmAdminState createState() => _ConfirmAdminState();
}

class _ConfirmAdminState extends State<ConfirmAdmin> {
        ...
        try {
          ...
          if (documents.length == 0) {
            ...
            for (DocumentSnapshot doc in documents) {
              ...
              setState(() {
                CourseAdminConstants.userData = doc;
