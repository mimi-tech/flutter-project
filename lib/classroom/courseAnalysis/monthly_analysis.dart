...
class MonthlyCoursesAnalysis extends StatefulWidget {
  @override
  _MonthlyCoursesAnalysisState createState() => _MonthlyCoursesAnalysisState();
}

class _MonthlyCoursesAnalysisState extends State<MonthlyCoursesAnalysis> {
  Widget space() {
    return SizedBox(
        ...
        child: Scaffold(
            ...
            body: CustomScrollView(slivers: <Widget>[
              ...
              SliverList(
                ...
                AnalysisCount(
                  name: kMonth.toString().toUpperCase(),
                  online:
