...
class MonthlyCompanyCoursesAnalysis extends StatefulWidget {
  @override
  _MonthlyCompanyCoursesAnalysisState createState() =>
      _MonthlyCompanyCoursesAnalysisState();
}

class _MonthlyCompanyCoursesAnalysisState
    extends State<MonthlyCompanyCoursesAnalysis> {
  Widget space() {
    return SizedBox(
              ...
              delegate: SliverChildListDelegate(
                [
                  ...
                  AnalysisCount(
                    ...
                    offLine: CourseAdminConstants.courseAdminLogout.length
                        .toString(),
                  ),
                        ...
                        return Column(
                          children: <Widget>[
                            workingDocuments.length == 0
                                ? NoStaffWorking(
                                    noStaff:
                                        '$kNoStaff in ${AnalysisConstants.companyName} this $kMonth')
                                : ListView.builder(
                                                      ...
                                                      children: <Widget>[
                                                        FlatButton(
                                                          ...
                                                          child: Column(
                                                            children: <Widget>[
                                                              Text(
                                                                '${workingDocuments[index]['semth'].toString()} : ${workingDocuments[index]['vfm'].toString()}',
                                                                style: GoogleFonts
                                                                    .rajdhani(
                                                                  fontSize:
                                                                      kFontsize
