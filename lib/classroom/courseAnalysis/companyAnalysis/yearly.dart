...
class YearlyCompanyCoursesAnalysis extends StatefulWidget {
  @override
  _YearlyCompanyCoursesAnalysisState createState() =>
      _YearlyCompanyCoursesAnalysisState();
}

class _YearlyCompanyCoursesAnalysisState
    extends State<YearlyCompanyCoursesAnalysis> {
  Widget space() {
    return SizedBox(
                      ...
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        ...
                        return Column(children: <Widget>[
                          workingDocuments.length == 0
                              ? NoStaffWorking(
                                  noStaff:
                                      '$kNoStaff in ${AnalysisConstants.companyName} this $kYear')
                              : ListView.builder(
                                                        ...
                                                        FlatButton(
                                                            ...
                                                            child: Column(
                                                              children: <
                                                                  Widget>[
                                                                Text(
                                                                  '${workingDocuments[index]['sey'].toString()} : ${workingDocuments[index]['vfy'].toString()}',
                                                                  style: GoogleFonts
                                                                      .rajdhani(
                                                                    fontSize:
                                                                        kFontsize
