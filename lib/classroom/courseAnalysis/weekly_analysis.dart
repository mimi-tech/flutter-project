...
class WeeklyCoursesAnalysis extends StatefulWidget {
  @override
  _WeeklyCoursesAnalysisState createState() => _WeeklyCoursesAnalysisState();
}

class _WeeklyCoursesAnalysisState extends State<WeeklyCoursesAnalysis> {
  Widget space() {
    return SizedBox(
