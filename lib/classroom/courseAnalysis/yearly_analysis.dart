...
class YearlyCoursesAnalysis extends StatefulWidget {
  @override
  _YearlyCoursesAnalysisState createState() => _YearlyCoursesAnalysisState();
}

class _YearlyCoursesAnalysisState extends State<YearlyCoursesAnalysis> {
  Widget space() {
    return SizedBox(
        ...
        child: Scaffold(
            ...
            body: CustomScrollView(slivers: <Widget>[
              ...
              SliverList(
                ...
                AnalysisCount(
                  name: kYear.toString().toUpperCase(),
                  online:
