...
class AllCoursesAnalysis extends StatefulWidget {
  @override
  _AllCoursesAnalysisState createState() => _AllCoursesAnalysisState();
}

class _AllCoursesAnalysisState extends State<AllCoursesAnalysis> {
  Widget space() {
    return SizedBox(
