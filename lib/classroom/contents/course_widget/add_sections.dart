...
class AddSectionEdit extends StatefulWidget {
  AddSectionEdit(
  ...
  @override
  _AddSectionEditState createState() => _AddSectionEditState();
}

class _AddSectionEditState extends State<AddSectionEdit>
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Text(widget.lectureCount.toString(),
                              style: GoogleFonts.rajdhani(
                                textStyle: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  color: kBlackcolor2,
                          ...
                          children: <Widget>[
                            Row(
                              children: <Widget>[
                                ...
                                OutlineButton(
                                  onPressed: () {},
                                  child: Text(widget.lectureCount.toString(),
                                      style: GoogleFonts.rajdhani(
                                        textStyle: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          color: kBlackcolor2,
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                initialValue: widget.lectureName,
                                readOnly: true,
                                maxLength: 100,
                                maxLines: null,
                                autocorrect: true,
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                OutlineButton(
                                  onPressed: () {},
                                  child: Text(
                                      (widget.sectionCounts + 1).toString(),
                                      style: GoogleFonts.rajdhani(
                                        textStyle: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          color: kBlackcolor2,
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Text((widget.sectionCounts + 1).toString(),
                                    style: GoogleFonts.rajdhani(
                                      textStyle: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        color: kBlackcolor2,
  ...
  void countingSection() {
    ...
    if ((url == null) || (imageUrl == null)) {
      ...
      /// TODO: Ellis to Miriam = This snippet has changed, please refer to the documentation
      // } else if ((Constants.uploadImageTask.isInProgress) &&
      //     (Constants.uploadTask.isInProgress)) {
      //   Fluttertoast.showToast(
      //       msg: kCourseUploadError2,
      //       toastLength: Toast.LENGTH_LONG,
      //       backgroundColor: kBlackcolor,
      //       textColor: kFbColor);
    } else {
      showDialog(
          ...
          builder: (context) => AlertDialog(
                ...
                title: AlertAnimation(
                    animation: animation, sectionCount: widget.sectionCounts),
...
/*send to database*/
    ...
    FirebaseFirestore.instance
      ...
      Fluttertoast.showToast(
          msg: (widget.sectionCounts + 1).toString() +
              'of' +
              widget.lectureCount.toString() +
