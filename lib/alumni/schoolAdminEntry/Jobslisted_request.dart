...
class JobsListing extends StatefulWidget {
  @override
  JobsListingState createState() => JobsListingState();
}

class JobsListingState extends State<JobsListing> {
  ...
  void checkJobsStatus(status, schoolAccountId) {
    FirebaseFirestore.instance
        .collection('jobsListing')
        .where('status', isEqualTo: status)
        .where('schAccId', isEqualTo: 'JobsListed')
        .get()
        .then((myDocuments) {
                  ...
                  if (snapshot.hasData) {
                    ...
                    if (jobsApplieds.isEmpty) {
                      ...
                      for (var jobsApplied in jobsApplieds) {
                        final cardWidget = JobsCards(jobsApplied: jobsApplied);
