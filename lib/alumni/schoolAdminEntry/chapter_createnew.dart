...
class CreateSchoolChapter extends StatefulWidget {
  @override
  _CreateSchoolChapterState createState() => _CreateSchoolChapterState();
}

class _CreateSchoolChapterState extends State<CreateSchoolChapter> {
...
//push chapter logo to firebase
      ...
      documentReference.set({
        ...
        'schId': UserStorage.loggedInUser.uid,
        'sl': url,
