...
class PersonsApplied extends StatefulWidget {
  @override
  _PersonsAppliedState createState() => _PersonsAppliedState();
}

class _PersonsAppliedState extends State<PersonsApplied> {
  @override
