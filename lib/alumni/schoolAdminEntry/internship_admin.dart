...
class NewsBoardInternshipAdmin extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _NewsBoardInternshipAdminState();
  }
}

_changeText() {}

class _NewsBoardInternshipAdminState extends State<NewsBoardInternshipAdmin> {
  List<String> uche = [
    kAppBarSchoolEvents,
    kAppBarJobs,
    kAppBarPromotions,
