...
class PersonsAccepted extends StatefulWidget {
  @override
  _PersonsAcceptedState createState() => _PersonsAcceptedState();
}

class _PersonsAcceptedState extends State<PersonsAccepted> {
  @override
          ...
          Container(
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  // final schoolRequests = snapshot.data.doc;
