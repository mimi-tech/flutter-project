...
class SchoolNewRequest extends StatefulWidget {
  @override
  _SchoolNewRequestState createState() => _SchoolNewRequestState();
}

class _SchoolNewRequestState extends State<SchoolNewRequest> {
  @override
  void initState() {
    super.initState();
  }
