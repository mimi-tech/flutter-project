...
class NewsBoardScholarshipAdmin extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _NewsBoardScholarshipAdminState();
  }
}

_changeText() {}

class _NewsBoardScholarshipAdminState extends State<NewsBoardScholarshipAdmin> {
  List<String> uche = [
    kAppBarSchoolEvents,
    kAppBarJobs,
    kAppBarPromotions,
