...
import 'package:sparks/alumni/schoolAdminEntry/admin_job_details.dart';
import 'package:sparks/alumni/strings.dart';
import 'package:sparks/app_entry_and_home/colors/colour.dart';

class JobsAdmin extends StatefulWidget {
  @override
  JobsAdminState createState() => JobsAdminState();
}

class JobsAdminState extends State<JobsAdmin> {
  List<String> uche = [
    kAppBarSchoolEvents,
    kAppBarJobs,
    kAppBarPromotions,
